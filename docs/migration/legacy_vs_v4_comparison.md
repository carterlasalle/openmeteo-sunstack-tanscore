...
## Current South Bend runs (live South Bend 2026-09-23 cloudy run (336 hourly rows, degraded/no-CAMS))

Source: `data/latest/tables/tan_forecast_hourly.parquet` (336 rows).

Mean legacy: 9.3; mean v4: 8.9; mean delta (v4-legacy): -0.4.
Median delta: +0.0; p10 -3.0; p90 +1.7.
...
| spectrum bin | n | mean legacy | mean v4 | mean delta |
|---|---|---|---|---|
| most UVB-rich | 31 | 29.4 | 32.6 | +3.2 |
| UVB-leaning | 31 | 30.5 | 31.6 | +1.1 |
| middle | 30 | 23.6 | 21.5 | -2.1 |
| UVA-leaning | 31 | 12.7 | 9.1 | -3.6 |
| most UVA-rich | 31 | 5.5 | 2.6 | -2.9 |
...
- Cloudy/high-UVA move (legacy 10-40 band): mean delta at cloud>=60 is -0.5 (n=43) vs -1.4 at cloud<30 (n=46). INCONCLUSIVE on cloud_cover alone this run (small/low-sun cloudy sample); the UVA/UVB-ratio bins are the direct mechanism test.
- Confidence vs intensity over lead time: confidence/lead Spearman -0.42 (declines distantly), Absolute/lead Spearman -0.01 (physics independent of horizon). CONFIRMED separate.
